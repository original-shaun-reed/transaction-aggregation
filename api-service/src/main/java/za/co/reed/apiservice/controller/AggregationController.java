...
public interface AggregationController {
        ...
        ResponseEntity<List<AggregationResponse>> summary(
        ...
        ResponseEntity<List<AggregationResponse>> topMerchants(@Valid
                                                               ...
                                                               @Valid
                                                               @Parameter(description = "Filter by status: PENDING, SETTLED, REVERSED") @RequestParam TransactionStatus status,
                        @Valid @Parameter(description = "Start of the period (inclusive)", example = "2026-03-01") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date from,
                        @Valid @Parameter(description = "End of the period (inclusive)", example = "2026-03-31") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date to,
                        @Valid @Parameter(description = "Limit of results") @RequestParam(defaultValue = "10") int limit);
        ...
        ResponseEntity<List<AggregationResponse>> byCategory(
                        @Parameter(description = "Filter to a specific account ID") @PathVariable String accountId,
                        @Parameter(description = "Start of the period (inclusive)", example = "2026-03-01") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date from,
                        @Parameter(description = "End of the period (inclusive)", example = "2026-03-31") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date to);
}
